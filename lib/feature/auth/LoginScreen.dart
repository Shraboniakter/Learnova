            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  // Forgot Password
                  Padding(
                    padding: EdgeInsets.only(right: 30.r, top: 5.r),
                    child: Align(
                      alignment: Alignment.centerRight,
                      child: Text(
                        "Forgot Password?",
                        style: TextStyle(color:Color(0xff008DE7,),fontSize: 14.spMin,fontWeight: FontWeight.w500),
                      ),
                    ),
                  ),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        Get.offAllNamed(AppRoutes.profileCourseScreen);
                      },
                      child: Text(
                        "Log In",
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: (){
                          Get.offAllNamed(AppRoutes.createScreen);
                        },
                        child: Text(
                          "Create an Account",
                          style: TextStyle(
